...
//for (let i = 0; ; i ++){
//  console.log(i);
//} - Infinite loops will break your code!
...
let jobs = ['farmer', 'officer', 'stylist', 'teacher', 'driver', 'performer'];
for(job of jobs){
    if(job.includes ('farmer') || job.includes ('teacher')){
        console.log(`${job} is a hard job!`);
    } else {
        console.log(`${job} is not an easy job!`);
    }
}
...
for(key of obj){ //objects do not contain iterable properties
    console.log(key);
}
